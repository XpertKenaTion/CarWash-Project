...
if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
    ...
    $sql = "SELECT * FROM DriverCarRequest WHERE id = ?";
        ...
        <div class="container">
          ...
          <div id="navbar-collapse" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="active"><a href="driverread.php">DRIVER READ</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <center><p><a href="driverhome.php" class="btn btn-primary">Back</a></p></center>
