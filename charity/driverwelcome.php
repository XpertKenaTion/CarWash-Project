          ...
          <div id="navbar-collapse" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="contactus.html">CONTACT US</a></li>
               ...
               <li class = "active"><a href="driverwelcome.php"> DRIVER WELCOME</a></li>
             <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="driverreset.php">RESET YOUR PASSWORD</a></li>
                  <li><a href="driverlogout.php">SIGN OUT OF YOUR ACCOUNT</a></li>
                  
                </ul>
              </li>
              
              <li class="probootstra-cta-button last"><a href="drivercreate.php" class="btn btn-primary">Driver Request</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="probootstrap-slider-text probootstrap-animate" data-animate-effect="fadeIn">
                ...
                <li><h1 class="probootstrap-heading probootstrap-animate">Hello Driver, <?php echo htmlspecialchars($_SESSION["username"]); ?>. Welcome to Safari Super Shine Car Wash.</h1></li>
