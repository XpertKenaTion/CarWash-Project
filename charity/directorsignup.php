...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["fullname"]))){
        ...
        $sql = "SELECT id FROM director WHERE fullname = ?";
    ...
    if(empty(trim($_POST["email"]))){
        ...
        // Prepare a select statement
        $sql = "SELECT id FROM director WHERE email = ?";
    ...
    if(empty(trim($_POST["username"]))){
        ...
        // Prepare a select statement
        $sql = "SELECT id FROM director WHERE username = ?";
    ...
    if(empty($fullname_err) && empty($email_err) && empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO director ( fullname,email,username, password) VALUES (?, ?, ?, ?)";
        ...
        <div class="container">
          ...
          <div id="navbar-collapse" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="active"><a href="signup.html">DIRECTOR SIGN UP</a></li>
...
<div class = "content">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Already have an account? <a href="directorlogin.php">Login here</a>.</p>
        </form>
    </div>
