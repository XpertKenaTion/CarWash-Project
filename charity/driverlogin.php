...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($fullname_err) && empty($email_err) && empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id,fullname,email,username, password FROM driver WHERE username = ?";
        ...
        <div class="container">
          <div class="navbar-header">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class = "active"><a href="login.html">DRIVER LOGIN</a></li>
...
<div class = "content">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have an account? <a href="driversignup.php">Sign up now</a>.</p>
        </form>
    </div>    
</body>
</html>