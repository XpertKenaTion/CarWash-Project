...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    header("location: directorlogin.php");
    exit;
}
?>
          ...
          <div id="navbar-collapse" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="contactus.html">CONTACT US</a></li>
               ...
               <li class = "active"><a href="directorwelcome.php"> DIRECTOR WELCOME</a></li>
             <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="directorreset.php">RESET YOUR PASSWORD</a></li>
                  <li><a href="directorlogout.php">SIGN OUT OF YOUR ACCOUNT</a></li>
                  
                </ul>
              </li>
              
              <li class="probootstra-cta-button last"><a href="directorhome.php" class="btn btn-primary">Driver Details</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="probootstrap-slider-text probootstrap-animate" data-animate-effect="fadeIn">
                ...
                <li><h1 class="probootstrap-heading probootstrap-animate">Hello Director, <?php echo htmlspecialchars($_SESSION["username"]); ?>. Welcome to Safari Super Shine Car Wash.</h1></li>
