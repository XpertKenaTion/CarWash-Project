...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: directorwelcome.php");
    exit;
}
        ...
        <div class="container">
          <div class="navbar-header">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class = "active"><a href="login.html">DIRECTOR LOGIN</a></li>
...
<div class = "content">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have an account? <a href="directorsignup.php">Sign up now</a>.</p>
        </form>
    </div>    
</body>
</html>''