...
// Validate email
    ...
    // Check input errors before inserting in database
     if(empty($name_err) && empty($email_err) && empty($phone_err) && empty($location_err) && empty($service_err) && empty($worker_err)&& empty($carplateno_err) && empty($slot_err)&& empty($payment_err)){
        ...
        $sql = "INSERT INTO CarWashDetails (name,email, phone,location,service,worker, carplateno,slot,payment) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<head>
    <meta charset="UTF-8">
    <title>Create Driver Record</title>
        ...
        <div class="container">
          ...
          <div id="navbar-collapse" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="active"><a href="managercreate.php">MANAGER CREATE</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                     ...
                     <input type="text" name="carplateno" class="form-control" value="<?php echo $carplateno; ?>">
                        ...
                        <center><a href="managerwelcome.php" class="btn btn-default">Cancel</a></center>
                    </form>
                </div>
            </div>        
        </div>
